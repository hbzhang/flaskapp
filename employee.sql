...
DROP DATABASE IF EXISTS `heroku_b1ddb90599150e5`;
CREATE DATABASE IF NOT EXISTS `heroku_b1ddb90599150e5` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `heroku_b1ddb90599150e5`;
